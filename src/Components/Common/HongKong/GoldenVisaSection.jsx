...
Residency
            ...
            Residency is granted through approved
financial investments.
          ...
          <div className="relative hidden md:flex justify-center -mt-50">
            <div className="relative z-10">
              <img
                src="/langma/images/hongkongrectangle.png"
          ...
          <div className="text-white md:-ml-5 mt-10 md:mt-0">
            ...
            <p className="text-[16px] md:text-[18px] leading-relaxed text-white">
             Hong Kong is a global financial and commercial
hub situated on the southern coast of China.
With a population of around 7.5 million, it
combines Chinese heritage with international
business practices. Cantonese and English are
widely used. Its advanced infrastructure, trade
network, and legal system support one of Asia’s
