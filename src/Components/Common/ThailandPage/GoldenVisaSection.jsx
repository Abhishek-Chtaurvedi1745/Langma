...
Residency
          ...
          Long-term residency is offered through
exclusive membership programs for investors.
            </p>
          ...
          <div className="relative hidden md:flex justify-center -mt-50">
            <div className="relative z-10">
              <img
                src="/langma/images/thailandrectangle.png"
          ...
          <div className="text-white md:-ml-5 mt-10 md:mt-0">
            ...
            <p className="text-[16px] md:text-[18px] leading-relaxed text-white">
             Thailand is a major Southeast Asian nation with
a population of around 71 million. It is
internationally known for tourism, Buddhist
heritage, and hospitality culture. Bangkok
remains a key business centre, while the
country’s tropical climate, cuisine, and
infrastructure provide a balanced lifestyle for
residents.
            </p>
          </div>
        </div>
