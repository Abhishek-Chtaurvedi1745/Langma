...
Golden Visa
          ...
          Long-term residency is granted to property
and business investors.
          ...
          <div className="relative hidden md:flex justify-center -mt-40">
            <div className="relative z-10">
              <img
                src="/langma/images/unitedtarabrectangle.png"
          ...
          <div className="text-white md:-ml-5 mt-10 md:mt-0">
            ...
            <p className="text-[16px] md:text-[18px] leading-relaxed text-white">
             The UAE is a federation of seven emirates with a
population exceeding 10.5 million. It is recognised
for modern infrastructure, trade leadership, and
investor-friendly regulations. Dubai and Abu Dhabi
serve as major global business centres with
tax-efficient residency frameworks.
            </p>
          </div>
        </div>
      </div>
