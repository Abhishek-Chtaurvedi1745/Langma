...
import ArabicProgramSection from "./KorianProgramSection";
import ArabicCoursesSlider from "./KorianCoursesSlider";
      ...
      <section className="relative w-full overflow-hidden bg-[#F7FAFC]">
        <div className="w-full grid grid-cols-1 min-h-[500px]">
          <div
            ...
            style={{
              backgroundImage: "url('/langma/images/korianbanner.png')",
