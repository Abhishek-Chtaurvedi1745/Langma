...
import ArabicProgramSection from "./GermanProgramSection";
import ArabicCoursesSlider from "./GermanCoursesSlider";
      ...
      <section className="relative w-full overflow-hidden bg-[#F7FAFC]">
        <div className="w-full grid grid-cols-1 h-[150px] md:h-[300px] lg:h-[400px] xl:h-[600px]">
          <div
            ...
            style={{
              backgroundImage: "url('/langma/images/germanbanner.png')",
