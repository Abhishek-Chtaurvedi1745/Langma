...
import ArabicProgramSection from "./SanskritProgramSection";
import ArabicCoursesSlider from "./SanskritCoursesSlider";
      ...
      <section className="relative w-full overflow-hidden bg-[#F7FAFC]">
        <div className="w-full grid grid-cols-1 h-[150px] md:h-[300px] lg:h-[400px] xl:h-[600px]">
          <div
            ...
            style={{
              backgroundImage: "url('/langma/images/Sanskritbanner.png')",
