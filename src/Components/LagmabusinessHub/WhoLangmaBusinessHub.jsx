    ...
    <section className="w-full bg-[#EAF8FF] py-16">
      <div className="max-w-7xl mx-auto px-6 flex flex-col lg:flex-row items-center gap-12">
          ...
          <ul className="space-y-3 mb-6 text-[#0E2A46] text-[20px]">
            ...
            <li className="flex items-start gap-3">
              <img
                ...
                className="w-5 h-5 mt-1"
              />
              <span>SMEs & Growing Enterprises</span>
            </li>
            <li className="flex items-start gap-3">
              <img
                src="/langma/images/check-mark_5290076 1.png"
            ...
            <li className="flex items-start gap-3">
              <img
                ...
                className="w-5 h-5 mt-1"
              />
              <span>Investors & Business Consultants</span>
            </li>
            <li className="flex items-start gap-3">
              <img
                src="/langma/images/check-mark_5290076 1.png"
                ...
                className="w-5 h-5 mt-1"
              />
              <span>Industry Associations & Institutions</span>
            </li>
          </ul>
        ...
        <div className="flex-1 flex justify-center lg:justify-end">
          <img
            src="/langma/images/Group 4359 copy.png" // Replace with your image path
